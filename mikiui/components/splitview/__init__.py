"""VS Code-like editor area component package.
...
- splitview.py : EditorTab, EditorGroup, and EditorArea components
...
from .splitview import EditorArea, EditorGroup, EditorTab

__all__ = ["EditorArea", "EditorGroup", "EditorTab"]
