...
## 5. WebRTC, Web APIs, and WebSockets
...
For production WebRTC across NATs, a TURN server is required regardless of backend mode.

---

## 6. File Size Budgets

### 6.1 Cloud Mode (Recommended Default)
...
### 6.2 On-Device Mode (Android Only)
...
## 8. Plugin System and Mobile Integration
...
### 8.2 Auto-Mapping to Capacitor Plugins
...
### 11.2 Security Guardrails for Mobile Build
...
## 13. Migration Path from Web/Desktop

### 13.1 For Existing MikiUI Apps
...
### 14.1 Build-Time (User's Machine)
...
### 14.3 No New Python Dependencies
...
## 16. Guardrails — When Mobile Work Can Begin
...
## 17. Implementation Order (Once Unblocked)
